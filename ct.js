...
ct.inputs.addAction('YMove', [{"code":"keyboard.KeyW","multiplier":-1},{"code":"keyboard.ArrowUp","multiplier":-1},{"code":"keyboard.KeyS","multiplier":1},{"code":"keyboard.ArrowDown","multiplier":1}]);
ct.inputs.addAction('XMove', [{"code":"keyboard.KeyD"},{"code":"keyboard.KeyA","multiplier":-1},{"code":"keyboard.ArrowLeft","multiplier":-1},{"code":"keyboard.ArrowRight"}]);
ct.inputs.addAction('Attack', [{"code":"keyboard.Space"},{"code":"keyboard.ShiftRight"},{"code":"keyboard.ShiftLeft"}]);
...
ct.rooms.templates['Main-Game-Room'] = {
    ...
    width: 800,
    height: 600,
    objects: [{"x":384,"y":512,"type":"Player"}],
    bgs: [{"depth":-2,"texture":"Space","extends":{"scaleX":1,"scaleY":1,"shiftX":0,"parallaxX":1,"movementX":0.1}}],
...
if(this.enemycounter > 0){
    ...
    ct.types.copy("Enemy",ct.random.range(0,800),0)
    this.enemycounter = 120
}
}

if(this.gameover && this.endtimer > 0){
    this.scoreLabel.x = 400
    this.scoreLabel.y = 400
    this.endtimer --
}else if(this.gameover && this.endtimer <= 0){
    this.gameover = false
    this.score = 0
    this.scoreLabel.x = 30
    this.scoreLabel.y = 30
    ct.types.copy("Player",384,512)
    this.endtimer = 300
}
    },
    onDraw() {
...
(function (ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"Wizard":{"frames":1,"shape":{"type":"rect","top":0,"bottom":16,"left":0,"right":16},"anchor":{"x":0,"y":0}},"Wizard_Big":{"frames":1,"shape":{"type":"rect","top":0,"bottom":16,"left":0,"right":16},"anchor":{"x":0,"y":0}},"Wizard_Big_Big":{"frames":1,"shape":{"type":"rect","top":0,"bottom":256,"left":0,"right":256},"anchor":{"x":0,"y":0}},"Wizard_Some_Big":{"frames":1,"shape":{"type":"rect","top":64,"bottom":64,"left":45,"right":45},"anchor":{"x":0.5,"y":0.5}},"Floor":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"floor_2":{"atlas":"./img/t1.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Space":{"atlas":"./img/t2.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"attack":{"frames":1,"shape":{"type":"circle","r":32},"anchor":{"x":0.5,"y":0.5}},"laser":{"frames":1,"shape":{"type":"rect","top":32,"bottom":32,"left":10,"right":10},"anchor":{"x":0.5,"y":0.5}},"enemy":{"frames":1,"shape":{"type":"strip","points":[{"x":27,"y":-32},{"x":0,"y":26},{"x":-27,"y":-31}],"closedStrip":true},"anchor":{"x":0.5,"y":0.5}}}][0],
...
if(ct.place.meet(this,"laser")){
    this.kill = true
    ct.sound.spawn("Exp",{loop:false,volume:0.3})
}

if(ct.actions.Attack.value == 1){
    if(this.firstclick){
        ct.types.copy("attack",this.x,this.y)
        this.firstclick = false
        ct.sound.spawn("Shoot",{loop:false,volume:0.5})
    }
}else{
...
this.move();
    ...
    onCreate: function () {
this.chosenSCALE = ct.random.dice(0.2,0.5,0.5,1.0,0.5,1.5)
this.scale.x = this.chosenSCALE
this.scale.y = this.chosenSCALE
    },
    extends: {}};
ct.types.list['attack'] = [];
...
if(this.shootcounter > 0){
    ...
    ct.types.copy("laser",this.x,this.y)
    ct.sound.spawn("Shoot",{loop:false,volume:0.5})
    this.shootcounter = ct.random.dice(60,120,30,10)
}
...
this.move();
    ...
    onDestroy: function () {
ct.room.score += ct.random.dice(100,200,400,600)
    },
    onCreate: function () {
this.cspeed = .5
this.shootcounter = ct.random.dice(60,120,120,100)
    },
    extends: {}};
ct.types.list['Enemy'] = [];
ct.types.templates["laser"] = {
    depth:-1,
    texture: "laser",
    onStep: function () {
this.y += ct.delta * this.cspeed
...
ct.sound.init('Shoot', {
    wav: './snd/d65b0cc6-2627-46a3-b323-8113e3fafeb2.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('Exp', {
    wav: './snd/1974a8a1-6ce1-40d6-a3fc-b0f85b9c7a3d.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
